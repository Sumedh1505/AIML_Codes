...
class SPi_basic_nlp:
    ...
    def basic_preprocessing(df, text_cols):
    ...
    def plural_to_singular(content):
    ...
    def after_preprocessings(df, str_1, top):
    ...
    def logistic_multiclass_model(self, param_range):
        ...
        model = GridSearchCV(LogisticRegression(class_weight='balanced', random_state=93, multi_class='multinomial'), tuned_parameters, scoring='f1_micro', cv=3)
